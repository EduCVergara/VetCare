<x-app-layout>
    ...
    <div class="max-w-3xl space-y-6">
        <section class="vet-dashboard-surface p-5">
            <p class="text-sm font-semibold text-teal-700 dark:text-teal-300">Ficha de cliente</p>
            <h2 class="mt-2 text-3xl font-semibold text-slate-950 dark:text-white">{{ $cliente->nombre }}</h2>
            <p class="mt-2 text-sm text-slate-500 dark:text-slate-400">
                Actualiza la información de contacto del tutor.
            </p>
        </section>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div class="md:col-span-2">
                        ...
                        <div class="vet-app-input-wrap relative mt-2">
                            ...
                            <input id="nombre" type="text" name="nombre" value="{{ old('nombre', $cliente->nombre) }}"
                    ...
                    <div>
                        ...
                        <div class="vet-app-input-wrap relative mt-2">
                            ...
                            <input id="telefono" type="text" name="telefono" value="{{ old('telefono', $cliente->telefono) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="vet-app-input-wrap relative mt-2">
                            ...
                            <input id="direccion" type="text" name="direccion" value="{{ old('direccion', $cliente->direccion) }}"
